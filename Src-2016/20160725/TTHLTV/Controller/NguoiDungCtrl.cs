...
using TTHLTV.DAL;
using TTHLTV.Component;
using TTHLTV.BAL;

namespace TTHLTV.Controller
{
    public class UserCtrl
    {
        UserData m_NguoiDungData = new UserData();
        UserInfo m_NguoiDungInfo = new UserInfo();
        BO_UserInfoCat m_LoaiNguoiDungInfo = new BO_UserInfoCat();
        ...
        public int DangNhap(string m_Username, string m_Password)
        {
            ...
            else
            {
                ...
                Utilities.User = m_NguoiDungInfo;
                return 2;
            }
        }
        #endregion
