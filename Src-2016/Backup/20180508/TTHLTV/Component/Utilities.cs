...
using TTHLTV.BAL;
//using TTHLTV.Reports;
//using TTHLTV.Controller;
//using DevComponents.DotNetBar;
using System.Collections.Generic;

namespace TTHLTV.Component
{
    #region Utilities
    ...
    {
        public static RegulationsInfo LayThongTinTruong()
        {
            RegulationsInfo m_Truong = new RegulationsInfo();
    ...
    public static class ThamSo
    {
        ...
        // 2012.03.12  Trieu comment start
